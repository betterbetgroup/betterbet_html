let globalFilters = {
    ...
    const CHANGE_TO_SMALLER_FONT_SIZE = 1510;
    const CHANGE_SIZE_OF_LAY_ODDS_AND_BACK_ODDS = 1380;
    const MIN_WIDTH_FOR_DATE_AND_TIME = 1275;
    const MIN_WIDTH_FOR_EXPECTED_PROFIT = 1240;
    const MIN_WIDTH_FOR_INFO = 1060;
...
function create_row(row) {
    ...
    let bookmaker_image = get_bookmaker_image(row.first_bookmaker)
    let win_exchange_image = get_bookmaker_image(row.second_bookmaker)
    let place_exchange_image = get_bookmaker_image(row.third_bookmaker)
...
function make_odds_and_platform_small_if_screen_small() {
        ...
        if (MAKE_ODDS_AND_BOOKMAKER_SMALL) {
                ...
                var oddsValues = document.querySelectorAll('.back_odds_value, .lay_odds_value, .lay_odds_value_2');
                ...
                var outcomes = document.querySelectorAll('.outcome_value');
                outcomes.forEach(function(outcome) {
                    outcome.style.marginLeft = '4px';
                });


                // Set styles for .at_symbol and .and_symbol
                var atAndSymbols = document.querySelectorAll('.at_symbol, .at_symbol_outcome');
                atAndSymbols.forEach(function(symbol) {
                    symbol.style.marginRight = '4px';
                    symbol.style.marginLeft = '4px';
                });

                // Adjust margin right specifically for .at_symbol_outcome
                var andSymbols = document.querySelectorAll('.at_symbol_outcome');
...
function go_to_input_and_update_global_for_the_input(filterId) {
    ...
    switch (filterId) {
        ...
        case 'min-outcomes':
            globalFilters.minoutcomes = parseFloat(document.getElementById('min-outcomes').value) || null;
            break;
        case 'min-rating':
...
example_data = [
    ...
    {
        "_createdDate": "Tue, 27 Aug 2024 11:06:40 GMT",
        "_id": "TqDQnPgCLKpyVUDYR9XL3g8x3OxoSGMz1TRI",
        "_owner": null,
        "_updatedDate": null,
        "date_and_time": "24/08/24 15:00",
        "first_bookmaker": "Paddy Power",
        "first_link": "https://www.paddypower.com/football/english-league-2/fleetwood-town-v-gillingham-33502744",
        "first_odds": "2.60",
        "first_outcome": "Fleetwood Town",
        "fixture": "Fleetwood Town v Gillingham",
        "game_day": "24/08/24",
        "game_time": "15:00",
        "league": "English League 2",
        "market_type": "Dutching",
        "potential_profit": "£17.75",
        "qualifying_loss": "-£0.39",
        "rating": "101.49%",
        "second_bookmaker": "Betway",
        "second_link": "https://betway.com/en/sports/evt/14322035",
        "second_odds": "3.25",
        "second_outcome": "Draw",
        "sport": "Football",
        "third_bookmaker": "William Hill",
        "third_link": "https://sports.williamhill.com/betting/en-gb/football/OB_EV32539148/fleetwood-vs-gillingham",
        "third_odds": "3.10",
        "third_outcome": "Gillingham", 
        "outcomes": 3
    },
    {
        "_createdDate": "Tue, 27 Aug 2024 11:06:40 GMT",
        "_id": "pThtAMvVaXXRVhtxhqcqlQtGVz8GlCtzeeBi",
        "_owner": null,
        "_updatedDate": null,
        "date_and_time": "24/08/24 15:00",
        "first_bookmaker": "William Hill",
        "first_link": "https://sports.williamhill.com/betting/en-gb/football/OB_EV32539319/wrexham-vs-reading",
        "first_odds": "2.15",
        "first_outcome": "Wrexham",
        "fixture": "Wrexham v Reading",
        "game_day": "24/08/24",
        "game_time": "15:00",
        "league": "English League 1",
        "market_type": "Dutching",
        "potential_profit": "£15.56",
        "qualifying_loss": "-£0.30",
        "rating": "101.40%",
        "second_bookmaker": "Paddy Power",
        "second_link": "https://www.paddypower.com/football/english-league-1/wrexham-v-reading-33503432",
        "second_odds": "3.50",
        "second_outcome": "Draw",
        "sport": "Football",
        "third_bookmaker": "Bet365",
        "third_link": "https://www.bet365.com/#/AC/B1/C1/D1003/E40/G105626781/",
        "third_odds": "3.80",
        "third_outcome": "Reading", 
        "outcomes": 3
    },
    {
        "_createdDate": "Tue, 27 Aug 2024 11:06:40 GMT",
        "_id": "iUMidJCZLMOlAZimX7MtiUV5NgyQ9uoPLo2j",
        "_owner": null,
        "_updatedDate": null,
        "date_and_time": "24/08/24 15:00",
        "first_bookmaker": "Matchbook",
        "first_link": "https://betway.com/en/sports/evt/14322062",
        "first_odds": "2.50",
        "first_outcome": "Cheltenham Town",
        "fixture": "Cheltenham Town v AFC Wimbledon",
        "game_day": "24/08/24",
        "game_time": "15:00",
        "league": "League Two",
        "market_type": "Dutching",
        "potential_profit": "£17.52",
        "qualifying_loss": "-£0.27",
        "rating": "101.07%",
        "second_bookmaker": "William Hill",
        "second_link": "https://sports.williamhill.com/betting/en-gb/football/OB_EV32539143/cheltenham-vs-afc-wimbledon",
        "second_odds": "3.25",
        "second_outcome": "Draw",
        "sport": "Football",
        "third_bookmaker": "Paddy Power",
        "third_link": "https://www.paddypower.com/football/english-league-2/cheltenham-v-afc-wimbledon-33502751",
        "third_odds": "3.30",
        "third_outcome": "AFC Wimbledon", 
        "outcomes": 3
    },
    {
        "_createdDate": "Tue, 27 Aug 2024 11:06:40 GMT",
        "_id": "iSqqwCJ46APbNhqeEZ18gmTqN9Kd5gQuh4RP",
        "_owner": null,
        "_updatedDate": null,
        "date_and_time": "24/08/24 15:00",
        "first_bookmaker": "William Hill",
        "first_link": "https://sports.williamhill.com/betting/en-gb/football/OB_EV32539143/cheltenham-vs-afc-wimbledon",
        "first_odds": "2.62",
        "first_outcome": "Cheltenham",
        "fixture": "Cheltenham v AFC Wimbledon",
        "game_day": "24/08/24",
        "game_time": "15:00",
        "league": "English League 2",
        "market_type": "Dutching",
        "potential_profit": "£18.20",
        "qualifying_loss": "-£0.19",
        "rating": "100.73%",
        "second_bookmaker": "Betway",
        "second_link": "https://betway.com/en/sports/evt/14322062",
        "second_odds": "3.10",
        "second_outcome": "Draw",
        "sport": "Football",
        "third_bookmaker": "Paddy Power",
