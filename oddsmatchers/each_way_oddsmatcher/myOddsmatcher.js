...
const SHOW_PLACES = 1210; 
const MEDIUM_FONT_WIDTH = 1130;
const SHOW_DATE_AND_TIME_WIDTH = 1025;
const SHOW_INFO_WIDTH = 0;
...
add_lock_if_premium() {
    ...
    function_using_global_data_and_global_filters_to_make_filtered_data() {
        ...
        filteredData = globalData.filter(row => {
            ...
            const potentialProfitMatch = globalFilters.minPotentialProfit === null || parseFloat(row.ROI.replace('%', '')) >= globalFilters.minPotentialProfit;
    ...
    make_filter_selection_value_as_saved(filter_name) {
        ...
        this.shadowRoot.querySelector('#filters-select').value = filter_name;
    ...
    set_font_size(width) {
        ...
        let expected_profit_header_width = '100px';
        ...
        if (width < MEDIUM_FONT_WIDTH) {
            ...
            expected_profit_header_width = '70px';
